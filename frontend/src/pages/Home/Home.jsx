...
function Home() {
  ...
  const handleInputChange = (event) => {
    ...
    console.log("Recipe name input updated: ", event.target.value);
  };

  // Handle switch change for enabling or disabling the DALLE API
  const handleSwitchChange = (event) => {
    setDalleAPIEnabled(event.target.checked);
    console.log("Dalle API enabled state changed: ", event.target.checked);
  };
          ...
          if (dalleAPIEnabled) {
            ...
            axios
              ...
              .then((response) => {
                ...
                console.log("Image generated: ", response.data.image);
              })
              .catch((error) => {
  ...
  console.log("About to return JSX from Home component");
  return (
    <Box
      sx={{
        display: "flex",
